...
if __name__ == '__main__':
    ...
    doc_words_path = output_dir / "tok_id_words.jsonl"
    doc_dist_path = output_dir / "tok_id_dist.json"
    doc_stat_path = output_dir / "tok_id_stat.json"
    ...
    with doc_words_path.open("w") as fOut:
        for did, document in tqdm(documents.items()):
            ...
            doc_words = filter_by_tokenizer(tokenizer, doc_string)

            fOut.write(json.dumps({"id": did, "tokens": doc_words}) + "\n")
